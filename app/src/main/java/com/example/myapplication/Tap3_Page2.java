...
public class Tap3_Page2 extends AppCompatActivity{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tap3_page2);
        ...
        before1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent (getApplicationContext(), Tap3_Page1.class);
        ...
        after1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (areAllRadioGroupsChecked()) {
                    ...
                    intent.putExtra("n_count",n_count);
                    intent.putExtra("s_count",s_count);
                    startActivity(intent);
                }
                else {
