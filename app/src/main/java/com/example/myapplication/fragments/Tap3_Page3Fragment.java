...
public class Tap3_Page3Fragment extends Fragment {
    ...
    public static Tap3_Page3Fragment newInstance() {
        return new Tap3_Page3Fragment();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view=inflater.inflate(R.layout.fragment_tap3_page3, container, false);
        ...
        sharedViewModel.getRadioGroup7CheckedId().observe(getViewLifecycleOwner(), new Observer<Integer>() {
            @Override
            public void onChanged(Integer checkedId) {
                radioGroup1.check(checkedId);
            }
        });
        sharedViewModel.getRadioGroup8CheckedId().observe(getViewLifecycleOwner(), new Observer<Integer>() {
            @Override
            public void onChanged(Integer checkedId) {
                radioGroup2.check(checkedId);
            }
        });
        sharedViewModel.getRadioGroup9CheckedId().observe(getViewLifecycleOwner(), new Observer<Integer>() {
            @Override
            public void onChanged(Integer checkedId) {
        ...
        after1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (areAllRadioGroupsChecked()) {
                    ((MainActivity)getActivity()).replaceFragment(Tap3_Page4Fragment.newInstance());
                }
                else {
        ...
        radioGroup1.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                sharedViewModel.setRadioGroup7CheckedId(checkedId);
            }
        });
        ...
        radioGroup2.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                sharedViewModel.setRadioGroup8CheckedId(checkedId);
            }
        });
        ...
        radioGroup3.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                sharedViewModel.setRadioGroup9CheckedId(checkedId);
            }
        });
        return view;
    }
